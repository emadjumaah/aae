...
// so vowelled input like أَرْسِلْ still matches unvowelled keywords like أرسل.

const TASHKEEL_RANGE =
...
const MODIFIER_PATTERNS: ModifierPattern[] = [
  {
    ...
    patterns: [
      ...
      /(?:^|[\s\u060C\u061B])(غداً|غدا|اليوم|الآن|الأسبوع القادم|الشهر القادم)(?:[\s\u060C\u061B]|$)/,
      /(?:^|[\s\u060C\u061B])(صباحاً|مساءً|بعد الظهر)(?:[\s\u060C\u061B]|$)/,
    ],
  },
  {
    key: "target",
