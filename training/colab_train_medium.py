#!/usr/bin/env python3
"""Arabic Algebra — Colab Training: MEDIUM model (~3.5M params)

Balanced: good capacity without overfitting on 18K examples.
Expected: converge in 8-15 epochs, ~10 min on T4, ~14 MB model file.
...
class Config:
    # MEDIUM: ~3.5M params — balanced for 18K examples
    d_model = 192
    nhead = 4
